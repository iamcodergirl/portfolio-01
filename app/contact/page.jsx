		...
		<section className="py-12">
            ...
            <Fade direction="left" delay={800} cascade damping={1e-1} triggerOnce={true}>
              <p className="subtitle max-w-[400px]">
                ...
                elit. Eius, officia reiciendis sint earum cum
                doloribus. Repellendus labore perferendis odio nemo,
                quos nihil quibusdam minima mollitia eaque laborum
                excepturi, error tenetur.
              </p>
            </Fade>
					</div>
